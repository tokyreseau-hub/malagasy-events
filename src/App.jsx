    ...
    <>
      <div onMouseEnter={()=>setHover(true)} onMouseLeave={()=>setHover(false)}
        ...
        <div onClick={()=>onSelect(event)} style={{position:"relative",height:180,overflow:"hidden"}}>
          <img src={event.image||"https://images.unsplash.com/photo-1533317480453-7a4b6ad0a174?w=400"} alt="" style={{width:"100%",height:"100%",objectFit:"cover",transition:"transform .3s",transform:hover?"scale(1.05)":"scale(1)"}}/>
